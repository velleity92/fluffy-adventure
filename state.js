...
export class StandingLeft extends State {
    ...
    handleInput(input){
        ...
        else if (input === 'PRESS down') this.player.setState(states.SITTING_LEFT); // set state to sittingleft
...
export class StandingRight extends State {
    ...
    handleInput(input){
        ...
        else if (input === 'PRESS down') this.player.setState(states.SITTING_RIGHT); // set state to sittingright
...
export class SittingLeft extends State {
    ...
    handleInput(input){
        if (input === 'PRESS right') this.player.setState(states.SITTING_RIGHT); // set state to SittingRight
...
export class SittingRight extends State {
    ...
    handleInput(input){
        if (input === 'PRESS left') this.player.setState(states.SITTING_LEFT); // set state to Sittingleft
...
export class RunningLeft extends State {
    ...
    handleInput(input){
        if (input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT); // set state to Sittingleft
...
export class RunningRight extends State {
    ...
    handleInput(input){
        if (input === 'PRESS left') this.player.setState(states.RUNNING_LEFT); // set state to Sittingleft
...
export class JumpingLeft extends State {
    ...
    enter(){
        ...
        this.player.maxFrame = 6;
        if (this.player.onGround()) this.player.vy -= this.player.gameHeight / 35;
